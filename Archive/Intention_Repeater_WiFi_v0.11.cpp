...
std::pair<std::string, int> multiplyIntention(const std::string &intention, const std::string &use_hashing, std::string::size_type buffer_size)
{
    std::string intention_multiplied = "", hashed_intention = "";
    int multiplier = 0;
...
int main()
{
    ...
    cout << "Intention Repeater WiFi Broadcaster v0.11" << endl;
